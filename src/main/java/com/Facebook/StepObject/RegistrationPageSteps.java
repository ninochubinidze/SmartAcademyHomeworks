...
public class RegistrationPageSteps extends RegistrationPage {
    ...
    public RegistrationPageSteps genderCustom() {
        customGender.click();
        Assert.assertTrue(preferredPronounInput.is(Condition.visible));
        customGenderInput.shouldBe(Condition.visible);
        return this;
    }
    public RegistrationPageSteps genderFemale() {
        fimaleGender.click();
        preferredPronounInput.shouldNotBe(Condition.visible);
        customGenderInput.shouldNotBe(Condition.visible);
        return this;
    }
    public RegistrationPageSteps PreferredPronoun(String pronoun) {
        preferredPronounInput.selectOption(pronoun);
        preferredPronounInput.shouldNotBe(Condition.empty);
        return this;
    }
}